				...
				<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
					...
					<div class="row placeholders">
						<div>
							...
							<form action="${pageContext.request.contextPath}/role/list.action" style="float: right;">
								<input type="text" placeholder="角色名" name="roleCode" value="${param.roleCode}" style="width: 100px;height: 26px" />
								<select name="roleState" style="width: 100px;height: 26px;margin-left: 10px;margin-right: 10px">
    ...
    ================================================== -->
		...
		<script>
			...
			$(".role-list").on("click", ".show-roleinfo-form", function() {
				...
				var role_name = $(this).parents("tr").find(".roleName").html();
			...
			//修改状态
			$(".role-list").on("click", ".updateState", function() {
				var roleState = null;
				var role_state = $(this).parents("tr").find(".roleState").text();
				var roleid = $(this).parents("tr").find(".roleid").html();
				if(role_state == "禁用") {
					roleState = "1";
				} else {
