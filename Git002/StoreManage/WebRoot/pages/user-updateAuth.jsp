		...
		<script type="text/javascript">
			...
			$(document).ready(function(){
				...
				$("#sure-modify").click(function(){
					...
					window.location.href="${pageContext.request.contextPath}/user/grantAuth.action?userId="+userId+"&authId="+authId+"";
				});
		...
		<div class="container-fluid" style="margin-top: 30px;">
			<div class="row">
				...
				<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
					...
					用户名：<input type="text" id="userCode" value="${userCode}" readonly="readonly" style="width: 100px"/>
