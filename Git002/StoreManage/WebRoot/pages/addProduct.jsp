      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="row placeholders">
            ...
            <form action="${pageContext.request.contextPath}/product/addPruduct.action" id="productMess">
            <table class="table table-hover table-bordered product-list">
            	...
            	<tr>
            		<td>仓库</td>
            		<td>
            			<input id="storeName" type="text" readonly="readonly"/>
            	...
            	<tr>
            		<td>品牌</td>
            		<td>
            			<input id="brandName" type="text" readonly="readonly"/>
            	...
            	<tr>
            		<td>条形码</td>
            		<td><input type="text" name="productNum" id="productNum"/></td>
            	</tr>
            	<tr>
            		<td>库存</td>
            		<td><input type="text" name="productInvent" id="productInvent"/></td>
            	</tr>
            	<tr>
            		<td>种类</td>
            		<td>
            	...
            	<tr>
            		<td>供应商</td>
            		<td>
            			<input id="supplyName" type="text"  />
            			<input id="supplyId" type="hidden" name="supplyId"/>
            	...
            	<tr>
            		<td>进价</td>
            		<td><input type="text" name="inPrice" id="inPrice"/></td>
            	</tr>
            	<tr>
            		<td>售价</td>
            	...
            	<tr>
            		<td>会员价</td>
            		<td><input type="text" name="memPrice" id="memPrice"/></td>
            	</tr>
            	<tr>
            		<td>出厂日期</td>
            		<td>
            			<input id="productDate" type="datetime" name="productDate"/>
            	...
            	<tr>
            		<td>保质期</td>
            		<td>
            			<input id="suppDate"  type="datetime" name="suppDate" />
            			<input class="suppDate" type="date" onchange="changeSuppDate()" />
            		</td>
            	</tr>
            </table>
            <input type="submit" class="btn btn-primary" onclick="checkProduct()" value="确认添加" />
            </form>
          </div>          
        </div>
    </div>
       ...
       var setting = {
    	...
    	/* 提交商品信息时，判断空值 */
   		$("form").submit(function(){
   			...
   			var productInvent=$("#productInvent").val();
   			...
   			if(!!productName  && !!storeId && !!brandId && !!productNum && !!productInvent && !!typeId && !!supplyId && !!placeId && !!unitId && !!introduce && !!inPrice && !!salePrice && !!memPrice && !!productDate && !!suppDate ){
   				return true;
   			}else{
   				alert("请完善商品信息！");
   				return false;
